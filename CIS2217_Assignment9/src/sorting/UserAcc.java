...
public abstract class UserAcc implements Serializable {
	...
	public UserAcc(String username, String password, boolean active) {
		this.username = username;
		this.password = password;
		this.active = true;
	}
	...
	public String toString() {
		...
		builder.append("UserAccountClass [username=");
